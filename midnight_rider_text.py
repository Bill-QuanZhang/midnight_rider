...
ENDGAME_TEXT = [
    """\n\nThe game has ended. Thanks for playing!""",  # Quit teh game
    """\n\nTEH AGENTS HAVE CLOSED IN ON YOU.
    ...
    YOU CAN TIME IT PERFECTLY SO THAT YOU SLIDE THE CAR IN AS GATES CLOSSE.
    
    YOU KNOW WOU DID THE RIGHT THING.
